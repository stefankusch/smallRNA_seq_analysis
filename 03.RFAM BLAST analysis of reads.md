...
```ShellSession
seqkit fq2fa RSB15248-1.trimmed.fastq -o RSB15248-1.trimmed.fa  #generating FASTA read file
sed 's/[[:space:]].*//g' RSB15248-1.trimmed.fa | sed 's/\:/\_/g' > RSB15248-1.trimmed.fasta  #simplifying FASTA headers
```
