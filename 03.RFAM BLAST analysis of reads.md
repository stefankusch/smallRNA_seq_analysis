...
# 5S rRNA
grep rf00001 Myc_rfam_other_besthit.m8 | sed 's/\=/\t/g' | awk '{SUM+=$2}END{print SUM}' 
grep rf00001 Myc_rfam_other_besthit.m8 | grep -v copies | awk '!x[$0]++' | awk 'BEGIN{i=0}{i++;}END{print i}'
# 5.8S rRNA
grep rf00002 Myc_rfam_other_besthit.m8 | sed 's/\=/\t/g' | awk '{SUM+=$2}END{print SUM}'
grep rf00002 Myc_rfam_other_besthit.m8 | grep -v copies | awk '!x[$0]++' | awk 'BEGIN{i=0}{i++;}END{print i}'
# 18S rRNA
grep rf01960 Myc_rfam_other_besthit.m8 | sed 's/\=/\t/g' | awk '{SUM+=$2}END{print SUM}'
grep rf01960 Myc_rfam_other_besthit.m8 | grep -v copies | awk '!x[$0]++' | awk 'BEGIN{i=0}{i++;}END{print i}'
# 28S rRNA
grep rf02543 Myc_rfam_other_besthit.m8 | sed 's/\=/\t/g' | awk '{SUM+=$2}END{print SUM}'
grep rf02543 Myc_rfam_other_besthit.m8 | grep -v copies | awk '!x[$0]++' | awk 'BEGIN{i=0}{i++;}END{print i}'
```
